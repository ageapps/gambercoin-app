<template>
  <div class="jumbotron centered">
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" placeholder="Peer Name. If empty a UUID will be created automatically" aria-label="PeerName" aria-describedby="basic-addon1"  v-model="peerName">
    </div>
    <div class="input-group mb-3">
      <div class="input-group-prepend">
